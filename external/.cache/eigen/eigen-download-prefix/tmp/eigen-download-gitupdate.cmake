...
execute_process(
  COMMAND "D:/Program Files (x86)/Git/cmd/git.exe" show-ref "3.2.10"
  WORKING_DIRECTORY "C:/Users/pijon/OneDrive/Desktop/animation3D/cmake/../external/eigen"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/pijon/OneDrive/Desktop/animation3D/cmake/../external/eigen'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/pijon/OneDrive/Desktop/animation3D/cmake/../external/eigen'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
